...
<div class="panel">
    <div class="panel-title box-title">
        ...
        <span class="pull-right"><a href="<?=$data['more']?>" class="font-12">More»</a></span>
        <?php endif;?>
    </div>
    <div class="new-list">
        ...
        <div class="panel-body border-bottom">      
            <div class="row">
                ...
                <div class="col-lg-8 btn-group">
                    ...
                    <a href="<?=Url::to(['post/detail','id'=>$list['id']])?>"><button class="btn btn-warning no-radius btn-sm pull-right">Read More</button></a>
                </div>
            </div>
            <div class="tags">
