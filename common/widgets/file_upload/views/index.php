...
<div class="per_upload_con" data-url="<?=$config['serverUrl']?>">
    ...
    <div class="per_upload_img">Upload Photo</div>
...
<!--         <p class="upbtn" ><a id="<?=$attribute?>" href="javascript:;" class="btn btn-success green choose_btn">选择图片</a></p>
        ...
        <p class="upbtn" ><a id="<?=$attribute?>" href="javascript:;" class="btn btn-success green choose_btn">Choose File</a></p>
        <p class="rule">Allowed file types: jpg, jpeg, png, gif<br>Files must be less than 1MB</p>
    </div>
